...
public class SmartEmailStack extends Stack {
  public SmartEmailStack(final Construct scope, final String id, StackProps props) {
    ...
    Function helloFunction = Function.Builder.create(this, "HelloFunction").runtime(Runtime.JAVA_17).
    handler("com.myorg.lambda.LambdaHandler").memorySize(512).timeout(Duration.seconds(10)).code(Code.fromAsset("../lambda/target/lambda-1.0-SNAPSHOT.jar")).build();
